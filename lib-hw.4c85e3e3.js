...
(0, _chartJs.Chart).register((0, _chartJs.LineController), (0, _chartJs.LineElement), (0, _chartJs.PointElement), (0, _chartJs.LinearScale), (0, _chartJs.CategoryScale), (0, _chartJs.Tooltip), (0, _chartJs.Legend));
const chartData = {
    labels: [
        "1",
        "2",
...
const salesChart = new (0, _chartJs.Chart)(graph, {
    type: "line",
    data: chartData,
    options: {}
});
...
},{}]},["eWhzT","78wdE"], "78wdE", "parcelRequirecdc0", {})

//# sourceMappingURL=lib-hw.4c85e3e3.js.map
